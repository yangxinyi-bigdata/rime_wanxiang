...
- [ ] 现在觉得之前对英文模式的处理确实太粗糙了,可能需要对segment进行处理,当时是没搞明白,segment是怎么处理的,所以导致了很多问题.如果重构将英文片段都标记到tags当中,是不是处理起来会方便很多呢? 
- [ ] at: ok n 这样输入的时候,删除键不好使.
- [ ] AI翻译: this is very good 你就是一个很好的人, 前面的英文部分没有发送过去
	- [ ] 先看看英文模式我有没有标记片段,应该标记了吧? 
- [x] 在ob中切换之后没有生效
切换没有生效应该如何测试呢?
